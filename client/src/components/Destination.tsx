                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-2">
                                                <button
                                                    ...
                                                    className={`block w-full text-left px-3 py-2 rounded-md transition-colors ${sortBy === "rating"
                                                            ? "bg-blue-500 text-white"
                                                            : "hover:bg-gray-100"
                                                        }`}
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className={`block w-full text-left px-3 py-2 rounded-md transition-colors ${sortBy === "duration"
                                                            ? "bg-blue-500 text-white"
                                                            : "hover:bg-gray-100"
                                                        }`}
                                                >
